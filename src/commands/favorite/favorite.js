...
module.exports = class Fav extends Interaction {
    ...
    async exec(int, data) {
        ...
        if (cmd === "add") {
            ...
            return int.editReply({
                content: `🔔 Added ${song.name} to your favorites!`,
                ephemeral: true,
            });
        }
        if (cmd === "remove") {
            ...
            return int.editReply({
                content: `❗️ Removed **${index}. ${old.name}** from your favorites!`,
                ephemeral: true,
            });
        }
        ...
        if (cmd === "list") {
            ...
            if (!sng.length)
                return int.editReply({
                    content: "❗️ You don't have any favorite songs!",
                    ephemeral: true,
                });
        ...
        if (cmd === "play") {
            ...
            if (!sng)
                return int.editReply({
                    content: "❗️ This song is not in your favorites!",
                    ephemeral: true,
                });

            await int.editReply({
                content: `🔔 Playing song **${sng.name}**!`,
                ephemeral: true,
            });
